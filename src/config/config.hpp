...
// TEXTURES
    ...
    // OBJECTS
    const std::string WALL_TEXTURE               = "wall_tree.jpg";

    const std::string SKY_TEXTURE                = "sky.jpeg";
    const std::string FLOOR_TEXTURE              = "floor.jpg";

    // BUTTONS
    const std::string PLAYGAME_PRESSED_TEXTURE   = "play_game_selected.jpg";
    const std::string SETTINGS_PRESSED_TEXTURE   = "buttons/settings_selected.jpg";
    const std::string ABOUT_PRESSED_TEXTURE      = "buttons/about_selected.jpg";
    const std::string QUIT_PRESSED_TEXTURE       = "buttons/quit_selected.jpg";

    const std::string PLAYGAME_TEXTURE           = "buttons/play_game.jpg";
    const std::string SETTINGS_TEXTURE           = "buttons/settings.jpg";
    const std::string ABOUT_TEXTURE              = "buttons/about.jpg";
    const std::string QUIT_TEXTURE               = "buttons/quit.jpg";

    const std::string TEXTURING_SELECT           = "buttons/texturing.jpg";
    const std::string SMOOTHING_SELECT           = "buttons/smoothing.jpg";
    const std::string COLLISION_SELECT           = "buttons/collision.jpg";

    const std::string TEXTURING_SELECT_S         = "buttons/texturing_selected.jpg";
    const std::string SMOOTHING_SELECT_S         = "buttons/smoothing_selected.jpg";
    const std::string COLLISION_SELECT_S         = "buttons/collision_selected.jpg";

    // WEAPONS
    const std::string PISTOLS_TEXTURE            = "weapons/pistols.png"; // "pistols"
    const std::string FIRE_PISTOLS_TEXTURE_RIGHT = "weapons/fire_pistols_right.png";
    const std::string FIRE_PISTOLS_TEXTURE_LEFT  = "weapons/fire_pistols_left.png";
    const std::string AIM_TEXTURE                = "weapons/aim.png";
